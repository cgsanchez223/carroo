...
class Car extends Vehicle{
    constructor(make, model, year) {
        super(make,model,year); // super can be used to extend objects from previous constructors
        this.numWheels = 4;
    }
}

let myFirstCar = new Car("Toyota", "Corolla", 2005);
console.log(myFirstCar.toString()); // This vehicle is a Toyota Corolla from 2005.
...
console.log(myFirstMotorcycle.toString()); // This vehicle is a Honda Nighthawk from 2000.
...
class Garage {
    ...
    add(newVehicle) {
        if (!(newVehicle instanceof Vehicle)) { // The instanceof operator tests to see if the prototype property of a constructor appears anywhere in the prototype chain of an object.
...
console.log(garage.vehicles); // (2) [Car, Motorcycle]
